...
# Note: The tests below rely upon images assets (for the rendered templates), so require that either:
# 1. The images assets have been processed - ie: `./manage.py collectstatic` has been run.
